...
export const E_CLI_001 = "E-CLI-001";
/// [E-CLI-002] 输出格式未知：输出格式取值未知
export const E_CLI_002 = "E-CLI-002";
/// [E-CLI-003] 参数组合非法：命令行参数组合非法：互斥项同时给出，或依赖项缺失
export const E_CLI_003 = "E-CLI-003";
/// [E-CLI-004] lint 只适用于 SML 文档：lint 只能检查 SML 文档
export const E_CLI_004 = "E-CLI-004";
/// [E-CLI-005] 目录模式必须指定输出目录：目录批量模式必须指定输出目录
export const E_CLI_005 = "E-CLI-005";
...
export const W_EDITOR_001 = "W-EDITOR-001";
/// [W-FEATURE-001] 位置参数写法已废弃：位置参数写法已废弃，推荐带参数名的写法
export const W_FEATURE_001 = "W-FEATURE-001";
/// [W-LINT-001] 片段定义从未被引用：片段定义后从未被引用
export const W_LINT_001 = "W-LINT-001";
/// [W-LINT-002] 契约定义从未被应用：契约定义后从未被应用
export const W_LINT_002 = "W-LINT-002";
/// [W-LINT-003] 同一块内键名重复：键在同一块内重复，后者会覆盖前者
export const W_LINT_003 = "W-LINT-003";
/// [W-LINT-004] 字段是空值：字段是空值
export const W_LINT_004 = "W-LINT-004";
/// [W-LINT-005] 嵌套超过建议阈值：嵌套深度已超过建议阈值
export const W_LINT_005 = "W-LINT-005";
