...
| **W9-分支保护** | GitHub 分支保护（W9.4，用户决定，**不入库**）：在 GitHub 仓库 Settings → Branches 开启 ① 合并前要求 CI 全绿 ② 禁止直推 main（走 PR）③ 收口「撤销/重开 PR」权限。核对清单见本会话 W9.4 报告 | GitHub 仓库设置 | 门禁真正生效（现在 CI 跑、但没人拦着你把红 commit 直推 main） | 无 | ✋ |
