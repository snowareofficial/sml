...
pub const W_EDITOR_001: &str = "W-EDITOR-001";
/// [W-FEATURE-001] 位置参数写法已废弃：位置参数写法已废弃，推荐带参数名的写法
pub const W_FEATURE_001: &str = "W-FEATURE-001";
/// [W-LINT-001] 片段定义从未被引用：片段定义后从未被引用
pub const W_LINT_001: &str = "W-LINT-001";
/// [W-LINT-002] 契约定义从未被应用：契约定义后从未被应用
pub const W_LINT_002: &str = "W-LINT-002";
/// [W-LINT-003] 同一块内键名重复：键在同一块内重复，后者会覆盖前者
pub const W_LINT_003: &str = "W-LINT-003";
/// [W-LINT-004] 字段是空值：字段是空值
pub const W_LINT_004: &str = "W-LINT-004";
/// [W-LINT-005] 嵌套超过建议阈值：嵌套深度已超过建议阈值
pub const W_LINT_005: &str = "W-LINT-005";
