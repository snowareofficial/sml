...
- **Multi-target emit**: once parsed to `Value`, compile to Markdown / LaTeX / XML / SVG / **HTML** / Slint UI / custom formats (emit backends, see `smltools`)
...
- [Ch12: smltools multi-target translator](/en/book/ch12-smltools) · [Ch13: External extensions](/en/book/ch13-extension) · [Appendix: Cheatsheet & troubleshooting](/en/book/appendix)
